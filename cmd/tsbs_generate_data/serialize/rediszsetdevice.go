...
// RedisZsetDeviceSerializer writes a Point in a serialized form for zsets
type RedisZsetDeviceSerializer struct{}

// Serialize writes Point data to the given writer, in a format that will be easy to create a redis-timeseries command
// from.
func (s *RedisZsetDeviceSerializer) Serialize(p *Point, w io.Writer) (err error) {
